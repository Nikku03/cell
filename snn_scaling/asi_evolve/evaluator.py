...
def evaluate(log_path: str) -> dict:
    ...
    out = {
        ...
        "evolved_cum_mean":       float(metrics.get("evolved_cum_mean", 0.0)),
        "evolved_init_ok":        bool(metrics.get("evolved_init_ok", True)),
        "evolved_step_errs":      int(metrics.get("evolved_step_errs", 0)),
        "gap_memrec_naive":       float(metrics.get("gap_memrec_naive", 0.0)),
        "gap_cls_naive":          float(metrics.get("gap_cls_naive",   0.0)),
        "gap_evolved_naive":      float(metrics.get("gap_evolved_naive", 0.0)),
