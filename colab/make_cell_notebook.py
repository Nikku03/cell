...
code("# build with hard failure if anything is missing (so we never silently ship the old committed HTML)",
   ...
   "    # persist CatPred outputs to virtual_cell_data/ so a future runtime restores them and SKIPS the ~30-min GPU run",
   ...
   "    print('copied all 3 apps + data + CatPred kinetics to Drive:', PROJ)"),
