...
code("# build with hard failure if anything is missing (so we never silently ship the old committed HTML)",
   ...
   "    _cp.run('pip install -q ipdb fair-esm progres rdkit-pypi transformers descriptastorus sentencepiece seaborn \"rotary_embedding_torch==0.6.5\" typed-argument-parser pandas-flavor tensorboardX', shell=True)",
