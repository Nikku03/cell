...
code("# [OUTPUT] bundle the WHOLE model into a single JSON you can download and hand back for evaluation",
   ...
   "    for f in ['convergence.json','reasoning.json','coexpr_neighbors.json','causal_reg.json','cell_instances.json','ncrna_targets.json','conditions.json','structure_function.json','domain_function.json','paxdb_abundance.json','context_networks.json','go_terms.json','cell_model_summary.json']:",
