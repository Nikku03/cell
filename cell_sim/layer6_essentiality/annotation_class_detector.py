...
_ESSENTIAL_CLASS_RULES: list[tuple[str, tuple[str, ...], tuple[str, ...]]] = [
    ...
    ("trna_thiolation",
     ("thiouridine",),
     ()),
    # v14: 30 more validated annotation classes mined from the v13 FN
    # pool. Each pattern verified against the full Breuer set to
    # produce ZERO Nonessential false positives; collectively they
    # capture 39 additional v13 FNs as TPs (no overlap with existing
    # classes). Grouping choice is biological-function-first so
    # evidence strings stay interpretable by reviewers.
    ("protein_deformylation",
     ("peptide deformylase",), ()),
    ...
    ("nad_biosynthesis",
     ("nad(+) synthase", "nad synthase", "nicotinate"), ()),
    ("dna_ligase",
     ("dna ligase",), ()),
    ("glycolysis_gapdh",
    ...
    ("ribose_5_phosphate_isomerase",
     ("ribose 5-phosphate isomerase",), ()),
    ("phosphatidylglycerol_synthase",
...
class AnnotationClassDetector:
    ...
    def detect_for_gene(
        ...
        mode_by_class = {
            ...
            # v14 classes (30) — grouped by downstream failure mode
            "protein_deformylation": FailureMode.TRANSLATION_STALL,
            "translation_initiation_formyltransferase": FailureMode.TRANSLATION_STALL,
            "methionine_aminopeptidase": FailureMode.TRANSLATION_STALL,
            "signal_recognition_particle": FailureMode.TRANSLATION_STALL,
            "methionine_adenosyltransferase": FailureMode.ESSENTIAL_METABOLITE_DEPLETION,
            "nad_biosynthesis": FailureMode.ESSENTIAL_METABOLITE_DEPLETION,
            "dna_ligase": FailureMode.DNA_REPLICATION_BLOCKED,
            "glycolysis_gapdh": FailureMode.ESSENTIAL_METABOLITE_DEPLETION,
            "ribosome_gtpase": FailureMode.TRANSLATION_STALL,
            "trna_pseudouridine_synthase": FailureMode.TRANSLATION_STALL,
            "ctp_synthase": FailureMode.ESSENTIAL_METABOLITE_DEPLETION,
            "excinuclease": FailureMode.DNA_REPLICATION_BLOCKED,
            "rrna_maturation": FailureMode.TRANSLATION_STALL,
            "ribosome_binding_factor": FailureMode.TRANSLATION_STALL,
            "acp_synthase": FailureMode.MEMBRANE_INTEGRITY,
            "trna_uridine_carboxymethylaminomethyl": FailureMode.TRANSLATION_STALL,
            "membrane_protein_insertase": FailureMode.MEMBRANE_INTEGRITY,
            "iron_sulfur_cluster": FailureMode.ESSENTIAL_METABOLITE_DEPLETION,
            "cysteine_desulfurase": FailureMode.ESSENTIAL_METABOLITE_DEPLETION,
            "thioredoxin_reductase": FailureMode.ESSENTIAL_METABOLITE_DEPLETION,
            "adenine_salvage_prt": FailureMode.ESSENTIAL_METABOLITE_DEPLETION,
            "uracil_salvage_prt": FailureMode.ESSENTIAL_METABOLITE_DEPLETION,
            "aaa_protease": FailureMode.TRANSLATION_STALL,
            "clp_protease": FailureMode.TRANSLATION_STALL,
            "ribonuclease_hi": FailureMode.TRANSCRIPTION_STALL,
            "ribonuclease_m5": FailureMode.TRANSLATION_STALL,
            "formyltetrahydrofolate_cyclo_ligase": FailureMode.ESSENTIAL_METABOLITE_DEPLETION,
